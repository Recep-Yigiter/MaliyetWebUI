...
export class IscilikGiderService {
  decode: any;
  loggedUserData:any;
  constructor(
  ...
  async create(create: any, successCallBack?: () => void, errorCallback?: (errorMessage: HttpErrorResponse) => void) {
    ...
    const observable = this.apiService.post({
      controller: "IscilikGiders",
      action: "CreateIscilikGider",
  ...
  async delete(id: string, successCallBack?: () => void, errorCallback?: (errorMessage: HttpErrorResponse) => void) {
    // https://localhost:7054/api/IscilikGiders/Delete/delete?id=1c91ccfc-a2e5-4930-84d1-1c794036eff9
