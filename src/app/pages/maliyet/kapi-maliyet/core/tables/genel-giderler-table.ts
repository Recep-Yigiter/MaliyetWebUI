...
@Component({
  selector: 'kapi-genel-giderler-table',
  template: `
...
<ng-template pTemplate="footer">
    <tr>
        ...
        <td style="font-size: 13px;">{{genelGiderMaliyet | currency: 'USD'}}</td>
    </tr>
</ng-template> 
</p-table>
  `,
...
export class KapiGenelGiderlerTableComponent {
    @Input() genelGiderler: any;
    @Input() genelGiderMaliyet: any;
