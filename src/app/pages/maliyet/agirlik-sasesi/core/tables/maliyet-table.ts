...
@Component({
  selector: 'agirlik-sasesi-maliyet-table',
  template: `
        <table id="myTable" class="yks_table_group " style="width:300px;">
                    ...
                    <tr style="border-bottom: 1px solid #b4b4b4;">
                      ...
                      <tr style="border-bottom: 1px solid #b4b4b4;">
                          ...
                          <td style="font-size: 12px;color: gray;text-align: left;padding-left:10px;display:flex; justify-content:space-between; align-item:center;" >{{genelGiderToplam?'₺'+genelGiderToplam.toFixed(2):0 | currency:' ₺':'symbol':'1.2-2'}}
                          <div class="portHeadLightMenu"
                                   style="display: flex;align-items: center;justify-content: center; margin: 0 20px;">
                                   <ul style="display: flex; position: relative;">
                                       <li>
...
export class AgirlikSasesiMaliyetTableComponent {
