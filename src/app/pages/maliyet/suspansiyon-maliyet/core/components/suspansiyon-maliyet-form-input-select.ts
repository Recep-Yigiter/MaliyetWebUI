...
@Component({
    selector: 'suspansiyon-maliyet-form-input-select',
    template: `
...
export class SuspansiyonMaliyetFormInputSelectComponent implements AfterViewInit,AfterViewChecked {
    ...
    selectedItem: any;
    selectedComp: any;
    constructor(private ref: ChangeDetectorRef,private readonly changeDetectorRef: ChangeDetectorRef) {
