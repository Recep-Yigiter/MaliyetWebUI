...
@Component({
  selector: 'app-kabin-maliyet-tablosu',
  templateUrl: './kabin-maliyet-tablosu.component.html',
  styleUrls: ['./kabin-maliyet-tablosu.component.scss']
})
export class KabinMaliyetTablosuComponent {
