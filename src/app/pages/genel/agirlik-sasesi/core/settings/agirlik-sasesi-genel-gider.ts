...
@Component({
    ...
    template: `
            <div class="modal-header " style="padding: 0rem 0rem;">
                ...
                style="border: none; height: 30px; width: 30px;" aria-label="Close" (click)="activeModal.close(false)">
                 ...
                 <div>
                    ...
                    <p-table id="row-check" [value]="gruplanmisVeri['Kabin Fabrikası']" [style]="{'min-height':' 400px'}" dataKey="id" [scrollable]="true"
                         ...
                         <ng-template pTemplate="body" let-product let-rowIndex="rowIndex">
                             ...
                             <tr >                   
                               <td>{{ product.ad }}</td>
                               <td *ngFor="let type of ['agirlikSasesi']">
...
export class AgirlikSasesiGenelGiderModalComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        this.gruplanmisVeri['Kabin Fabrikası'].forEach(element => {
            toplamGenelGider += element.katsayilar["agirlikSasesi"] / 28;
        })
