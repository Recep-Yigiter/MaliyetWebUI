...
@Component({
    selector: 'app-agirlik-sasesi-iscilik-modal',
    styleUrls: ['../../create-agirlik-sasesi/create-agirlik-sasesi.component.scss'],
    template: `
            ...
            <div>
                ...
                <div style="display: grid; grid-template-columns:1fr; gap: 4px;">
                    <div style="display: flex; flex-direction: column; border: 1px solid rgb(230, 230, 230); color: white; padding: 4px;">
                        ...
                        <agirlik-sasesi-form [span]="170" [label]="'Ortalama Maaş'">
                        ...
                        <agirlik-sasesi-form [span]="170" [label]="'Üret. Per. Sayısı'">
                            <input type="number" disabled="false" form-control [(ngModel)]="frm.uretimdekiPersonelSayisi" name="ad"
                                class="form-control shadow-none form-control-nullable"
                                style="height: 26px;  " id="exampleFormControlInput1">
                        </agirlik-sasesi-form>
                        <agirlik-sasesi-form [span]="170" [label]="'Üretim Sayısı'">
...
export class AgirlikSasesiIscilikModalComponent implements OnInit {
    ...
    async ngOnInit() {
        this.iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "agirlik-sasesi")[0];
