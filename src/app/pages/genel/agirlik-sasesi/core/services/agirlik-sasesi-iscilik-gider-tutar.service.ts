...
export class AgirlikSasesiIscilikGiderTutarService {
    genelGiderler: any;
    ...
    async result() {
        var iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "agirlik-sasesi")[0];
