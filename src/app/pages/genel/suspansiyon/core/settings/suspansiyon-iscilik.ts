...
@Component({
    selector: 'app-suspansiyon-iscilik-modal',
    styleUrls: ['../../create-suspansiyon/create-suspansiyon.component.scss'],
    template: `
            ...
            <div>
                ...
                <div style="display: grid; grid-template-columns:1fr; gap: 4px;">
                    <div style="display: flex; flex-direction: column; border: 1px solid rgb(230, 230, 230); color: white; padding: 4px;">
                        ...
                        <suspansiyon-form [span]="170" [label]="'Ortalama Maaş'">
                        ...
                        <suspansiyon-form [span]="170" [label]="'Üret. Per. Sayısı'">
                            <input type="number" disabled="false" form-control [(ngModel)]="frm.uretimdekiPersonelSayisi" name="ad"
                                class="form-control shadow-none form-control-nullable"
                                style="height: 26px;  " id="exampleFormControlInput1">
                        </suspansiyon-form>
                        <suspansiyon-form [span]="170" [label]="'Üretim Sayısı'">
...
export class SuspansiyonIscilikModalComponent implements OnInit {
    ...
    async ngOnInit() {
        this.iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "süspansiyon")[0];
