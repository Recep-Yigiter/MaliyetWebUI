...
@Component({
    selector: 'app-panel-kapi-grup-iscilik-modal',
...
export class PanelKapiGrupIscilikModalComponent implements OnInit {
    ...
    async ngOnInit() {
        this.iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "panel")[0];
