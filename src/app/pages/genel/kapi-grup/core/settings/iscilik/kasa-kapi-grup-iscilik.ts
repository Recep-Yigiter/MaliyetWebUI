...
@Component({
    selector: 'app-kasa-kapi-grup-iscilik-modal',
...
export class KasaKapiGrupIscilikModalComponent implements OnInit {
    ...
    async ngOnInit() {
        this.iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "kasa")[0];
