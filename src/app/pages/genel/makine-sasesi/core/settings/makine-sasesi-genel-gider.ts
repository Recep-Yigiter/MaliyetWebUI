                ...
                <div style="display: grid; grid-template-columns:1fr; gap: 4px;">
                    ...
                    <p-table id="row-check" [value]="gruplanmisVeri['Kabin Fabrikası']" [style]="{'min-height':' 400px'}" dataKey="id" [scrollable]="true"
                         ...
                         <ng-template pTemplate="body" let-product let-rowIndex="rowIndex">
                             ...
                             <tr >                   
                               <td>{{ product.ad }}</td>
                               <td *ngFor="let type of ['makineSasesi']" >
...
export class MakineSasesiGenelGiderModalComponent implements OnInit {
    ...
    async ngOnInit() {
        ...
        this.gruplanmisVeri['Kabin Fabrikası'].forEach(element => {
            toplamGenelGider += element.katsayilar["makineSasesi"] / 28;
        })
