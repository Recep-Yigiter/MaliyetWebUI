...
@Component({
    selector: 'app-makine-sasesi-iscilik-modal',
    styleUrls: ['../../create-makine-sasesi/create-makine-sasesi.component.scss'],
    template: `
        ...
        <div>
                <div style="display: grid; grid-template-columns:1fr; gap: 4px;">
                    <div style="display: flex; flex-direction: column; border: 1px solid rgb(230, 230, 230); color: white; padding: 4px;">
                        <makine-sasesi-form [span]="170" [label]="'Ortalama Maaş'">
                        ...
                        <makine-sasesi-form [span]="170" [label]="'Üret. Per. Sayısı'">
                            <input type="number" disabled="false" form-control [(ngModel)]="frm.uretimdekiPersonelSayisi" name="ad"
                                class="form-control shadow-none form-control-nullable"
                                style="height: 26px;  " id="exampleFormControlInput1">
                        </makine-sasesi-form>
                        <makine-sasesi-form [span]="170" [label]="'Üretim Sayısı'">
...
export class MakineSasesiIscilikModalComponent implements OnInit {
    ...
    async ngOnInit() {
        this.iscilikSetting = (await this.IscilikSettingService.GetAll()).items.filter(c => c.prosesAdi == "makine-sasesi")[0];
