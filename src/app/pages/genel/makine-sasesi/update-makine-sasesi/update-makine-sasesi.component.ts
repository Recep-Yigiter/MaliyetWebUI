...
export class UpdateMakineSasesiComponent implements OnInit {
  ...
  sil(){
      ...
      modalRef.result.then(async (event) => {
        if (event == true) {
          this.MakineSasesiService.delete(this.data.id, async () => {
            this.activeModal.close(true);
          });
  ...
  kapasite: any = [
    { ad: 'Ray Arası=0-105cm', },
    { ad: 'Ray Arası=105-240cm', },
    { ad: 'Ray Arası=240cm - ∞', },
    { ad: 'Kuyu Derinliği=0-105cm', },
    { ad: 'Kuyu Derinliği=105-240cm', },
    { ad: 'Kuyu Derinliği=240cm - ∞', },
    { ad: 'Kuyu Genişliği=0-105cm', },
    { ad: 'Kuyu Genişliği=105-240cm', },
    { ad: 'Kuyu Genişliği=240cm - ∞', },
